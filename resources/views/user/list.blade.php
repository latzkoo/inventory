...
<main role="main" class="flex-shrink-0">
    <section class="content my-5">
        <div class="container m-auto">
            <div class="row mb-2">
                <div class="col-6 p-0"><h3>Felhasználók</h3></div>
                <div class="col-6 p-0">
                    <div class="button-add-new">
                        <a href="/felhasznalok/add">
            ...
            <div class="container bg-white rounded shadow-sm px-0 py-3 mb-3">
                <div class="row">
                    <div class="col-6 pl-3">
                        <div class="admin-list-items"><span class="font-weight-bolder">Összesen:</span> {{ count($users) }} elem</div>
                    </div>
                ...
                <div class="row p-0">
                    <div class="col-12 p-0">
                        <div class="alert alert-success" role="alert">
                            <div class="font-weight-bold">A felhasználó törlése sikeres.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row p-0">
                    <div class="col-12 p-0">
                        <div class="alert alert-danger" role="alert">
                            <div class="font-weight-bold">A felhasználó nem törölhető!</div>
                        </div>
                    </div>
                </div>
            @endif
            ...
            <div class="container bg-white rounded shadow-sm p-3">
                <table class="table table-hover table-sm">
                    ...
                    @foreach($users as $user)
                        <tr>
                            <td><a class="link-operation text-secondary" href="/felhasznalok/edit/{{ $user->felhasznaloID }}">{{ $user->vezeteknev }} {{ $user->keresztnev }}</a></td>
                            <td>{{ $user->email }}</td>
                            <td>
                                <div class="operations">
                                    <a href="/felhasznalok/edit/{{ $user->felhasznaloID }}">
                                    ...
                                    <button type="button" class="btn btn-operations-small btn-danger ml-1 button-delete" title="Törlés"
                                            data-href="/felhasznalok/delete/{{ $user->felhasznaloID }}">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Biztos, hogy törli a felhasználót?
            </div>
