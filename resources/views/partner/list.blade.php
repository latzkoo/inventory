...
<main role="main" class="flex-shrink-0">
    <section class="content my-5">
        <div class="container m-auto">
            <div class="row mb-2">
                <div class="col-6 p-0"><h3>Partnerek</h3></div>
                <div class="col-6 p-0">
                    <div class="button-add-new">
                        <a href="/partnerek/add">
            ...
            <div class="container bg-white rounded shadow-sm px-0 py-3 mb-3">
                <div class="row">
                    <div class="col-6 pl-3">
                        <div class="admin-list-items"><span class="font-weight-bolder">Összesen:</span> {{ count($partners) }} elem</div>
                    </div>
            ...
            <div class="container bg-white rounded shadow-sm p-3">
                <table class="table table-hover table-sm">
                    ...
                    @foreach($partners as $partner)
                        <tr>
                            <td><a class="link-operation text-secondary" href="/partnerek/edit/{{ $partner->partnerID }}">{{ $partner->partnernev }}</a></td>
                            <td>{{ $partner->cim }}</td>
                            <td>
                                <div class="operations">
                                    <a href="/partnerek/edit/{{ $partner->partnerID }}">
                                    ...
                                    <button type="button" class="btn btn-operations-small btn-danger ml-1 button-delete" title="Törlés"
                                            data-href="/partnerek/delete/{{ $partner->partnerID }}">
