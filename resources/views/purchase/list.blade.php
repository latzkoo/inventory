...
<main role="main" class="flex-shrink-0">
    <section class="content my-5">
        <div class="container m-auto">
            <div class="row mb-2">
                <div class="col-6 p-0"><h3>Beszerzések</h3></div>
                <div class="col-6 p-0">
                    <div class="button-add-new">
                        <a href="/beszerzes/add">
                ...
                <div class="row p-0">
                    <div class="col-12 p-0">
                        <div class="alert alert-success" role="alert">
                            <div class="font-weight-bold">A beszerzés törlése sikeres.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row p-0">
                    <div class="col-12 p-0">
                        <div class="alert alert-danger" role="alert">
                            <div class="font-weight-bold">A beszerzés nem törölhető!</div>
                        </div>
                    </div>
                </div>
            @endif
                            ...
                            <td>
                                <div class="operations">
                                    ...
                                    <button type="button" class="btn btn-operations-small btn-danger ml-1 button-delete" title="Törlés"
                                            data-href="/beszerzes/delete/{{ $movement->mozgasID }}">
